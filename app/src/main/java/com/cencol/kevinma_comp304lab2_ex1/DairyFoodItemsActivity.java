...
public class DairyFoodItemsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instructionsTV.setText(R.string.dairy_food_items_instructions);
        ...
        for (String vegName : getResources().getStringArray(R.array.dairy)) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //disable the dairy menu item to prevent end user confusion
